...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/eliesjebri/DevOps-hello-world.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-eliesjebri-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-eliesjebri-service.yml;
                ```
Save and run the job.
